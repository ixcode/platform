...
public class FlatJsonPrinterTest {
    ...
    public void json_object() {
        ...
        assertThat(result).isEqualTo("{ \"foo\" : 34, \"bar\" : \"barry\" }");
    }
    ...
    public void json_array() {
        ...
        assertThat(result).isEqualTo("[ { \"johnny\" : \"foo\", \"fooby\" : 4435 }, { \"focsle\" : \"ar!\" } ]");
    }
    ...
    public void simple_array() {
        ...
        assertThat(result).isEqualTo("[ 456, true, false, null, \"hello\" ]");
    }
    ...
    public void complex_tree() {
        ...
        assertThat(result).isEqualTo("[ { \"johnny\" : \"foo\", \"fooby\" : 4435, \"child\" : { \"focsle\" : \"ar!\", \"aList\" : [ 1, 2 ] } } ]");
    }
